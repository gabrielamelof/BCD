...
-- ------------------------------------------------------------------
-- EXERCÍCIO 1: Crie uma trigger que insira os dados do usuário excluído na tabela UsuarioExcluido.
...
DROP TRIGGER IF EXISTS trg_bfr_delete;
...
FOR EACH ROW
BEGIN
        INSERT INTO UsuarioExcluido (id_usuario, nome_usuario, email_usuario, data_exclusao)
...
INSERT INTO Usuario (nome, numero_identificacao, email, data_cadastro, nivel_associacao) VALUES 
('Lucas Santos', 'USR0j1', 'lucas@email.com', '2023-01-10', 'regular');
...
DROP TRIGGER IF EXISTS trg_data;
...
INSERT INTO Emprestimo (usuario_id, livro_id, data_devolucao_limite, data_devolucao) VALUES 
(401, 301, '2024-01-20', '2024-01-18');
